...
"""
Description: Amazon Rekognition Adapter implementation for the VisionProvider port.

This file contains the `RekognitionAdapter` class, which serves as the infrastructure adapter
for the AWS Rekognition service within the Hexagonal Architecture. It handles the communication
with AWS, translates external DTOs to domain entities, and manages specific error handling for the vision provider.
...
# -------------------------------------------------------------------------------------
# End of backend/infrastructure/vision/rekognition_adapter.py
# -------------------------------------------------------------------------------------
