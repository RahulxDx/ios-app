...
DESCRIPTION: S3 Storage Adapter
             Implements StorageProvider port using Amazon S3.
             Handles uploads, downloads, and presigned URLs for secure
             file management within the application.
============================================================================
