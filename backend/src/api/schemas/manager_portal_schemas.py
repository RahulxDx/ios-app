"""
============================================================================
FILE: manager_portal_schemas.py
DESCRIPTION: Manager Portal API Schemas
             Pydantic models for Manager Portal aggregated data responses.
             Defines structures for facility, zone, and country compliance data.
============================================================================
...
"""
============================================================================
END OF FILE: manager_portal_schemas.py
============================================================================
AUTHOR: Dinesh Kumar G M
WEBSITE: https://www.stellantis.com/
============================================================================
