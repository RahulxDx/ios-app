...
============================================================================
FILE: hygiene.py
DESCRIPTION: Hygiene Analysis API Routes
             This module defines endpoints for facility cleanliness analysis.
             It handles image uploads, automated analysis using AWS Rekognition/Gemini,
             manual overrides, and statistical reporting.
============================================================================
