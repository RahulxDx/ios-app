...
DESCRIPTION: FastAPI Application Factory
             This module defines the Application Factory for the Dealer Hygiene Vision API.
             It handles application creation, middleware configuration, database initialization,
...
from .api.routes import hygiene, auth, vision
...
def create_app() -> FastAPI:
    ...
    # WHY: Flutter app and web dashboard need cross-origin access
    app.add_middleware(
        CORSMiddleware,
        allow_origins=["*"],  # Allow all origins (mobile app, web dashboard)
    ...
    app.include_router(vision.router)  # Vision Analysis with Gemini
